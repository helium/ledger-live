...
test("signPaymentV2 with no memo", async () => {
  const transport = await openTransportReplayer(
    RecordStore.fromString(`
        => e00800004a00e1f50500000000b88800000000000019000000000000000011e6e9e5a6bdb879e93cd298c39470437cb1288f0ecd4447594f67b4c96e6b54f500000000000000000000000000000000
...
test("signPaymentV2 with a memo", async () => {
  const transport = await openTransportReplayer(
    RecordStore.fromString(`
        => e00800004a00e1f50500000000b88800000000000019000000000000000011e6e9e5a6bdb879e93cd298c39470437cb1288f0ecd4447594f67b4c96e6b54f5796f6c6f000000000000000000000000
...
test("signTokenBurnV1", async () => {
  const transport = await openTransportReplayer(
    RecordStore.fromString(`
        => e00c0000420100000000000000b888000000000000180000000000000030000000000000000011e6e9e5a6bdb879e93cd298c39470437cb1288f0ecd4447594f67b4c96e6b54f5
...
test("signTransferValidatorStakeV1 as old owner", async () => {
  const transport = await openTransportReplayer(
    RecordStore.fromString(`
        => 
